...
class DataInput:
    ...
    def extract_yearly_variation(self, file_name, index_sets, scenario=""):
        ...
        if df_input is not None:
            ...
            df_output = self.extract_general_input_data(df_input, df_output, file_name, index_name_list, default_value, time_steps=self.energy_system.set_time_steps_yearly_entire_horizon)
