...
class ETHColors:
    ...
    def set_colors_countries(self):
        self.colors["country_max"] = {
            "AT": self.get_color("bronze", 40),
            "BE": self.get_color("bronze", 100),
            "BG": self.get_color("green", 80),
            ...
            "MT": self.get_color("petrol", 40),
            "NL": self.get_color("bronze", 80),
    ...
    def set_colors_scenarios(self):
        self.colors["scenarios"] = {
            # biomass scenarios
            "reference": self.get_color("green", "dark"),
            "referenceEU": self.get_color("green", 80),
            "noBM": self.get_color("green", 40),
            # hydrogen scenarios
            "min": self.get_color("petrol", 40),
            "td": self.get_color("petrol", 100),
            "bau": self.get_color("red", 40),
            "h2_push": self.get_color("green", 40),
            "h2push": self.get_color("green", 40),
    ...
    def get_custom_colormaps(self, color, diverging=False, reverse=False):
