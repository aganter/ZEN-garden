...
class ETHColors:
    ...
    def set_colors_techs(self):
        self.colors["techs"] = {
            ...
            "SMR90": self.get_color("blue", 80),
            "biomethane SMR": self.get_color("petrol", 40),
            "biomethane SMR90": self.get_color("petrol", 80),
            "gasification": self.get_color("green", 40),
            "gasification57": self.get_color("green", 80),
            ...
            "onwind": self.get_color("blue",60),
            "offwind": self.get_color("blue", "dark"),
            "solar": self.get_color("bronze",60),
            "WON": self.get_color("blue", 60),
            "WOF": self.get_color("blue", "dark"),
            "PV": self.get_color("bronze", 60),
            "all": self.get_color("purple","dark"),
    ...
    def get_custom_colormaps(self, color, diverging=False, reverse=False):
        ...
        if diverging:
            ...
            colorSeq = [self.get_color(color, shade) for shade in list(self.base_colors[color].keys())] + [(1, 1, 1)]
        if not reverse:
            colorSeq.reverse()
